...
uses string.format() method and format specification.
"""
...
print('Hi,', name, 'this program will convert integer numbers between three base systems')
while True :
    ...
    # use exception handling since the conversion would crash to many inputs:
    try:
